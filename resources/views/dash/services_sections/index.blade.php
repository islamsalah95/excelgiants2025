            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Services Sections</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($servicesSections as $section)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('services-sections.edit', $section->id) }}"
                                                    class="btn btn-sm btn-primary" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form action="{{ route('services-sections.destroy', $section->id) }}"
