                        ...
                        <form action="{{ route('about-sections.update', $aboutSection->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" required>{{ old('description', $aboutSection->description) }}</textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Image</label>
                                    <input type="file" class="form-control" name="image" accept="image/*">
                                    @if ($aboutSection->getFirstMediaUrl('image'))
                                        <div class="mt-2">
                                            <img src="{{ $aboutSection->getFirstMediaUrl('image') }}" width="100"
                                                class="rounded">
                                        </div>
                                    @endif
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                            {{ $aboutSection->is_active ? 'checked' : '' }}>
