    ...
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dash/assets/css/vendors/themify.css') }}">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dash/assets/css/vendors/flag-icon.css') }}">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dash/assets/css/vendors/feather-icon.css') }}">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dash/assets/css/vendors/slick.css') }}">
    ...
    <link id="color" rel="stylesheet" href="{{ asset('dash/assets/css/color-1.css') }}" media="screen">
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dash/assets/css/responsive.css') }}">
